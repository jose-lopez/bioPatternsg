...
public class RSATWSBindingStub extends org.apache.axis.client.Stub implements RSATWS.RSATWSPortType {
    ...
    private static void _initOperationDesc5(){
        ...
        /* New */
        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("peak_motifs");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "request"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("urn:RSATWS", "PeakMotifsRequest"), RSATWS.PeakMotifsRequest.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("urn:RSATWS", "PeakMotifsResponse"));
        oper.setReturnClass(RSATWS.PeakMotifsResponse.class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "response"));
        oper.setStyle(org.apache.axis.constants.Style.WRAPPED);
        oper.setUse(org.apache.axis.constants.Use.LITERAL);
        _operations[44] = oper;
...
/* New */
            qName = new javax.xml.namespace.QName("urn:RSATWS", "PeakMotifsRequest");
            cachedSerQNames.add(qName);
            cls = RSATWS.PeakMotifsRequest.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("urn:RSATWS", "PeakMotifsResponse");
            cachedSerQNames.add(qName);
            cls = RSATWS.PeakMotifsResponse.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
/* New */            
...
/* New */
   public RSATWS.PeakMotifsResponse peak_motifs(RSATWS.PeakMotifsRequest request) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
            throw new org.apache.axis.NoEndPointException();
        }
        org.apache.axis.client.Call _call = createCall();
        ...
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("urn:RSATWS", "peak_motifs"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {request});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (RSATWS.PeakMotifsResponse) _resp;
            } catch (java.lang.Exception _exception) {
                return (RSATWS.PeakMotifsResponse) org.apache.axis.utils.JavaUtils.convert(_resp, RSATWS.PeakMotifsResponse.class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
  throw axisFaultException;
